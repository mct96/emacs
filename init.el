...
(add-to-list 'load-path "~/.emacs.d/emacs_ext/hl-todo")
(require 'hl-todo)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(spacemacs-theme rainbow-mode telephone-line docker-compose-mode dockerfile-mode ess bnf-mode sphinx-doc cmake-project cmake-font-lock sml-mode crux multiple-cursors rainbow-delimiters cyberpunk-theme dracula-theme ##))
...
;; git clone git@github.com:nschum/highlight-symbol.el.git
(add-to-list 'load-path "~/.emacs.d/emacs_ext/highlight-symbol.el/")
...
(add-to-list 'load-path "~/.emacs.d/emacs_ext/multiple-cursors.el/")
...
(add-to-list 'load-path "~/.emacs.d/emacs_ext/projectile/")
(require 'projectile)
(projectile-mode +1)
...
(add-to-list 'load-path "~/.emacs.d/emacs_ext/emacs-neotree/")
(require 'neotree)
(global-set-key [f8] 'neotree-toggle)
(setq neo-theme (if (display-graphic-p) 'icons 'arrow))

;; git clone git@github.com:domtronn/all-the-icons.el.git
(add-to-list 'load-path "~/.emacs.d/emacs_ext/all-the-icons.el/")
...
;; git clone git@github.com:dbordak/telephone-line.git
(add-to-list 'load-path "~/.emacs.d/emacs_ext/telephone-line/")
